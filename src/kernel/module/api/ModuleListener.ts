...
import { ListenerActionsMetadata, ListenerAction } from "./ListenerAction.js";
import { ListenerActionUnavaliable } from "../../exceptions/kernel/ListenerActionUnavaliable.js";
...
export abstract class ModuleListener extends EventEmitter {
     ...
     */
    public abstract getMetadataFromExposedActions(): ListenerActionsMetadata;
    ...
    public async handleRequest(request: ListenerRequest) {
        ...
        let actionsDefinition: ListenerActionsMetadata = this.getMetadataFromExposedActions();
